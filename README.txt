...
Contributors: alphapay.com.br
Donate link: https://www.alphapay.com.br/
Tags: Brazilian Payment, alphapay, woocommerce, master, visa, elo, hiper, brazil, brazilian gateway, credit card online payment method, método pagamento cartão de crédito, página pagamento, brasileiro, Brasil, checkout, integration, integração, automação, automation, 
...
Add the AlphaPay Payment Gateway on your woocommerce plugin, it's a very simple way to receive your payment in Brazilian Real (currency of Brazil). <PTBR>Adicione a AlphaPay Gateway de Pagamento em seu plugin do woocommerce, é o jeito mais simples de receber seus pagamentos na moeda real brasileira.
...
[AlphaPay - Payment Gateway](https://alphapay.com.br/) é um método de pagamento brasileiro desenvolvido pela empresa LKS Ontology Desenvolvimento e Consultoria, em parceria comercial com a ITMAN e AlphaPay.

Este plugin possue parcerias comerciais das empresas [ITMAN](https://itman.com.br) e da [AlphaPay](https://alphapay.com.br).
O desenvolvido deste plugin foi feito a partir da [documentação oficial da AlphaPay](https://prd-sales.alphapay.com.br/swagger/index.html) e utiliza a última versão da API de pagamentos da AlphaPay.
...
* [Lucas Kague - AlphaPay](https://alphapay.com.br), [Lucas Kague - Itman](https://itman.com.br), contribuir nos testes integrados, validações e funcionalidades.
...
É obrigatório possuir uma conta na AlphaPay (https://usergateway.alphapay.com.br/);
Versão do PHP >= 5.4+
Wordpress >= 4.x+
...
* Only one account on [AlphaPay](http://usergateway.alphapay.com.br/ "AlphaPay").
...
Note que é necessário aprovação da AlphaPay para utilizar o Checkout Transparente, saiba mais em "[Como receber pagamentos pela AlphaPay](https://gateway.alphapay.com.br/receba-pagamentos.html)".
